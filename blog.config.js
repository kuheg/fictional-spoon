...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kirin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '轻盘点,轻分享', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '分享,博客,教程,VPS,轻小说', // 网站关键词 英文逗号隔开
  ...
  // POST类型文章的默认路径前缀，例如默认POST类型的路径是  /[slug]
